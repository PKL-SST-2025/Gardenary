...
import { loginUser, syncUserToProfile } from "../services/api"; 
...
const Login: Component = () => {
  ...
  const handleLogin = async (e: Event) => {
    ...
    try {
      ...
      if (result.success) {
        // Sync user data to profile immediately after successful login
        syncUserToProfile();
  ...
  return (
    <>
      ...
      <div class="min-h-screen relative overflow-hidden">
        ...
        {/* Continue with other vegetable elements - keeping them for visual appeal */}
        {/* (I'll include a few key ones to keep the code manageable) */}
            ...
            <div class="relative backdrop-blur-lg bg-white/80 border border-white/20 rounded-3xl shadow-2xl p-10 transform hover:scale-105 transition duration-300">
              ...
              <div class="relative z-10">
                ...
                <div class="text-center mb-8 animate-fade-in-down">
                  ...
                  <p class="text-gray-600 mt-2 font-medium">Login to continue your garden journey</p>
                </div>
                ...
                <div class="space-y-6 animate-fade-in-up">
                  ...
                  <p class="text-center text-gray-600 font-medium">
                    ...
                    <A 
                      href="/signup" 
                      class="text-green-700 font-bold hover:text-emerald-600 transition duration-300 relative inline-block group"
                    >
                      Sign Up
